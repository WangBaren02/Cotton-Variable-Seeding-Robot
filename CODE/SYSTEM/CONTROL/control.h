...
#define LeftLight GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_9)
#define RightLight GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_11)
...
extern float Servo5_Base, Servo6_Base, Servo7_Base, Servo8_Base;		
